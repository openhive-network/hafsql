...
const indexes = [
  {
    ...
    skip: false,
    comment: "sorting by ID (op_id) on op_* & vo_* views",
  },
  ...
  `CREATE INDEX CONCURRENTLY IF NOT EXISTS hafsql_memo_pattern_idx ON hive.operations ((body_binary::jsonb->'value'->>'memo') text_pattern_ops, id DESC)
    WHERE op_type_id = ${opIds.transfer};`,
  // account
