...
export const setupOperationViews = async () => {
  ...
  AS SELECT o.id AS op_id,
    ...
    (o.body_binary::jsonb -> 'value'::text) ->> 'author'::text AS "author",
    (o.body_binary::jsonb -> 'value'::text) ->> 'permlink'::text AS "permlink",
    hafsql.asset_amount((o.body_binary::jsonb -> 'value'::text) ->> 'max_accepted_payout'::text) AS "max_accepted_payout",
    hafsql.asset_symbol((o.body_binary::jsonb -> 'value'::text) ->> 'max_accepted_payout'::text) AS "max_accepted_payout_symbol",
